  ...
  <body>  
    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            ...
            <li><a href="#" class="active"><i class="fa fa-bar-chart fa-fw"></i>Data Visualization</a></li>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li><a href="data-visualization.php">Charts</a></li>
                <li><a href="data-visualization_boards.php" class="active">Boards</a></li>
		...
		<img src="SBC-NodeMCU-ESP32-02.png" width="250" height="250">
