...
//	$user_name_global = $_SESSION['user_name'];
	 //$cluster_id_var = $_REQUEST['cluster_id'];
...
<html lang="en">
  <head>
    ...
    <title>AgreHelper - Изтриване на клъстер</title>
            ...
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                ...
                <!-- <li><a href="edit-cluster.php">Настройки на клъстер</a></li>
                 <li><a href="delete-cluster.php" class="active">Изтриване на клъстер</a></li>-->
                </ul>
            </nav>
          </div>
        </div>
      ...
      ?>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">Изтриване на клъстер</h2>
            <p>Страницата позволява изтриването на създаден клъстер (групи от агрометеостанции, който са разположени в близка географска локация или по друг избран от потребителя признак).</p>
            
            
            <!-- да добавя обработка-->
            <form action="delete-cluster-in-db.php" class="templatemo-login-form" method="post" enctype="multipart/form-data">
              ...
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    ...
                    <input type="number" class="form-control" id="inputKlusterCoordinate1" name="cluster_geolocation21"  value=<?=$cluster_geolocation1_var;?>>                  
                </div>
                </div>
            <div class="row form-group">    
                <div class="col-lg-6 col-md-6 form-group">                  
     ...
     <!--         
              <div class="row form-group">
                <div class="col-lg-12 form-group">                   
                    ...
                    <textarea class="form-control" id="inputNote" rows="3" name="cluster_additional_description1"  value=<?php echo str_replace([' ', "\t"], ['&nbsp;', '&nbsp;&nbsp;'], nl2br(htmlentities($cluster_additional_description_var))) ?>></textarea>
                </div>
              </div>
              
         --> 
              <div class="form-group text-left">
                <button type="submit" class="templatemo-blue-button" name="id1"  value=<?=$id;?>>Изтрий клъстера</button>
