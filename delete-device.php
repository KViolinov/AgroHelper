...
<html lang="en">
  <head>
    ...
    <title>AgreHelper - Изтриване на агрометеостанция</title>
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                 ...
                 <li><a href="delete-device.php" class="active">Изтриване на агрометеостанция</a></li>-->
                </ul>
            </nav>
          </div>
        </div>
      ...
      ?>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">Изтриване на асоциирана агрометеостанция</h2>
            <p>Страницата визуализира информация за асоциираните агрометеостанции.</p>
     <form action="delete-device-in-db.php" class="templatemo-login-form" method="post" enctype="multipart/form-data">
             ...
             <!-- да се добави четене от база данни с клъстери и да се предвиди падащо меню за избор -->
              ...
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    ...
                    <input type="number" class="form-control" id="inputDeviceCoordinate1" name="device_geolocation11" value=<?=$device_geolocation1_var;?>>                  
                </div>
                </div>
            <div class="row form-group">    
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputDeviceCoordinate2">Геолокация / Географска дължина (във формат 25.6272318)</label>
                    <input type="number" class="form-control" id="inputDeviceCoordinate2" name="device_geolocation21" value=<?=$device_geolocation2_var;?>>                  
                </div> 
              </div>
            ...
            <div class="row form-group">    
              ...
              <div class="form-group text-left">
                <button type="submit" class="templatemo-blue-button" name="id1"  value=<?=$id;?>>Изтрий агрометеостанция</button>
