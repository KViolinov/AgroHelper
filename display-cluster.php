...
<html lang="en">
  <head>
    ...
    <title>AgreHelper - Визуализация на клъстери</title>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                 <li><a href="display-cluster.php" class="active">Визуализация на клъстерите</a></li>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">Информация за създадените клъстери</h2>
            <p>Страницата визуализира информация за създадените клъстери (групи от агрометеостанции, който са разположени в близка географска локация или по друг избран от потребителя признак).</p>
...
$sql="SELECT * FROM kvbbgcom_agrohelper.clusters WHERE `user_id`=?";
...
<tr><td align="center"><?php echo $row["cluster_id"]; ?></td>
<td align="center"><?php echo $row["cluster_name"]; ?></td>
<td align="center"><?php echo $row["cluster_description"]; ?></td>
<td align="center">
<a href="edit-cluster.php?id=<?php echo $row["id"]; ?>&user_name_current=<?php echo $user_name_global; ?>">Редактиране</a>
</td>
<td align="center">
<a href="delete-cluster.php?id=<?php echo $row["id"]; ?>&user_name_current=<?php echo $user_name_global; ?>">Изтриване</a>
</td>
</tr>
<?php $count++; } ?>
</tbody>
